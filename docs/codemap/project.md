...
- Last updated: `2026-08-04` (manage-import #02: kind=product + useImportProducts + 商品顶栏导入｜导出; `parseYuanToCents`; 商品导入模板)
...
- Children:
  ...
  - `src/import/` — import pure logic (manage-import #01/#02/#03). Responsibility: staff template/parse/preview; product [build-product-import-template.ts](../../../src/import/build-product-import-template.ts) (`商品导入模板.xlsx` 名称+单价), [parse-product-import-workbook.ts](../../../src/import/parse-product-import-workbook.ts), [preview-product-import.ts](../../../src/import/preview-product-import.ts) (title trim / voided clash / yuan→cents); restock [build-restock-import-template.ts](../../../src/import/build-restock-import-template.ts) (`补货导入模板.xlsx` 商品名称+数量), [parse-restock-import-workbook.ts](../../../src/import/parse-restock-import-workbook.ts), [preview-restock-import.ts](../../../src/import/preview-restock-import.ts) (active-product match / voided vs missing / qty / in-file dup). Key dep: `xlsx@0.18.5`.
