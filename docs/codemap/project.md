...
- Last updated: `2026-08-04` (checkout-self-use spec #01: `stock_record.self_use` + v5 ALTER; dual-freeze v1+v3 CREATE; `aggregateBundleRetail` skips self-use out for 单数·零售)
