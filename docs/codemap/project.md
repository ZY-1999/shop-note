...
- Children:
  ...
  - `src/export/` — shared export pipeline (manage-export #02/#03/#04). Responsibility: [types.ts](../../../src/export/types.ts) (`ExportJob`), [run-export.ts](../../../src/export/run-export.ts) (availability gate → build → `expo-file-system/legacy` cache write → `expo-sharing`; swallows `User canceled`), [build-staff-workbook.ts](../../../src/export/build-staff-workbook.ts) (`buildStaffWorkbook` → base64 xlsx; `staffExportFilename`), [build-product-workbook.ts](../../../src/export/build-product-workbook.ts) (`buildProductWorkbook` → base64 xlsx; `productExportFilename`; 单价 via `formatCentsAsYuan`). Independent of `src/data/` and UI. Key deps: `expo-file-system/legacy`, `expo-sharing`, `xlsx@0.18.5`.
