...
- Updated: `2026-07-10` — summary day-collapse: each 流水 day section is now a collapsible card (default collapsed, `openDays` set, header tap toggles) mirroring the 库存卡; staff-row expand + batching unchanged. See `.scratch/2026-07-10-summary-day-collapse/`.
