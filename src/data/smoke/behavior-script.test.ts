 ...
 * Together they prove behavioral parity; this test alone proves the script is
 * well-formed and its step sequence is sound (a malformed step would otherwise
 * surface only on device).
 */
describe("behaviorScript (tracer bullet) — InMemory half", () => {
  test("every tracer step returns a defined result, in sequence", async () => {
