...
- **管理页导入 manage-import (2026-08-04)** — 会员/商品/补货顶栏「导入」→ 根 Stack `import-form`（`kind` + 可选 `confirmExtra`）；xlsx 模板/`expo-document-picker` → 预览 → bulk mutation（MutationQueue、单次 toast）；按姓名/名称去重只新建。见 [.scratch/2026-08-04-manage-import/](.scratch/2026-08-04-manage-import/)。
...
- **管理页导入 PRD**: [.scratch/2026-08-04-manage-import/01-manage-import.md](.scratch/2026-08-04-manage-import/01-manage-import.md)（specs 01–03）
